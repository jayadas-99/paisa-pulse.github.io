export function friendlyAuthError(error) {
  ...
  if (message.includes("PERMISSION_DENIED")) {
    return "Firebase Realtime Database rejected this write. Update your database rules so signed-in users can read and write only their own pulseUsers/{uid} data.";
  }
