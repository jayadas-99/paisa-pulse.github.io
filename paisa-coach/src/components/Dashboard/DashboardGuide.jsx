export default function DashboardGuide() {
  return (
    <section className="card">
      <h2 className="font-heading text-xl font-bold">How to use Paisa Coach</h2>
      <div className="mt-4 grid gap-3 md:grid-cols-4">
        <GuideItem title="1. Upload" text="Add last month's statement to build your money map." />
        <GuideItem title="2. Review" text="Fix wrong categories once. Paisa Coach remembers that merchant." />
